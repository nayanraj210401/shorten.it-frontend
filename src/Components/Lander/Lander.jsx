...
export const Lander = () => {
  ...
  const onSubmit = (e) => {
    ...
    try {
      ...
      alert(
        "Couldn't create the Short Link something went wrong, Please try later"
      );
    }
  };
  ...
  const copyToClipBoard = () => {
    if (!validateText()) {
      alert(
        "There is ntg to copy, make sure to click on shorten Button provided"
      );
      return;
    }
    ...
    <>
      <section className="hero-container">
        <div className="hero-text">
          <div className="txt1">Got a Long URL that you want to share</div>
          <div className="txt2">Just Shorten.It</div>
          <div className="txt3">It’s that simple !!!</div>
        </div>
